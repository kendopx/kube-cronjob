...
docker build -f Dockerfile . -t $AWS_ACCOUNT.dkr.ecr.us-east-2.amazonaws.com/cron-restart-jira-pod:latest
...
docker push $AWS_ACCOUNT.dkr.ecr.us-east-2.amazonaws.com/cron-restart-jira-pod:latest
